...
\begin{align*}
\begin{autobreak}
\frac{d}{dx}((0 - \sin(\sin(x))) \cdot \cos(x) + x^{2} \cdot 3) = \frac{d}{dx}((0 - \sin(\sin(x))) \cdot \cos(x)) + \frac{d}{dx}(x^{2} \cdot 3)
\end{autobreak}
\end{align*}
...
Текущий ход событий: \begin{align*}
\begin{autobreak}
(0 - \cos(\sin(x)) \cdot \cos(x)) \cdot \cos(x) + (0 - \sin(\sin(x))) \cdot (0 - \sin(x)) + x \cdot 2 \cdot 3
\end{autobreak}
\end{align*}
...
\begin{align*}
\begin{autobreak}
\frac{d}{dx}((0 - \cos(\sin(x)) \cdot \cos(x)) \cdot \cos(x) + (0 - \sin(\sin(x))) \cdot (0 - \sin(x)) + x \cdot 2 \cdot 3) = \frac{d}{dx}((0 - \cos(\sin(x)) \cdot \cos(x)) \cdot \cos(x) + (0 - \sin(\sin(x))) \cdot (0 - \sin(x))) + \frac{d}{dx}(x \cdot 2 \cdot 3)
\end{autobreak}
\end{align*}
