...
Текущий ход событий: \begin{align*}
\begin{autobreak}
(0 - \sin(\sin(x))) \cdot \cos(x) + x^{3} \cdot 3 \cdot \frac{1}{x}
\end{autobreak}
\end{align*}
...
\begin{align*}
\begin{autobreak}
\frac{d}{dx}((0 - \sin(\sin(x))) \cdot \cos(x) + x^{3} \cdot 3 \cdot \frac{1}{x}) = \frac{d}{dx}((0 - \sin(\sin(x))) \cdot \cos(x)) + \frac{d}{dx}(x^{3} \cdot 3 \cdot \frac{1}{x})
\end{autobreak}
\end{align*}
...
\begin{align*}
\begin{autobreak}
\frac{d}{dx}(x^{3} \cdot 3 \cdot \frac{1}{x}) = \frac{d}{dx}(x^{3}) \cdot 3 \cdot \frac{1}{x} + x^{3} \cdot \frac{d}{dx}(3 \cdot \frac{1}{x})
\end{autobreak}
\end{align*}
...
\begin{align*}
\begin{autobreak}
\frac{d}{dx}(3 \cdot \frac{1}{x}) = \frac{d}{dx}(3) \cdot \frac{1}{x} + 3 \cdot \frac{d}{dx}(\frac{1}{x})
\end{autobreak}
\end{align*}
...
Текущий ход событий: \begin{align*}
\begin{autobreak}
(0 - \cos(\sin(x)) \cdot \cos(x)) \cdot \cos(x) + (0 - \sin(\sin(x))) \cdot (0 - \sin(x)) + x^{3} \cdot 3 \cdot \frac{1}{x} \cdot 3 \cdot \frac{1}{x} + x^{3} \cdot 3 \cdot \frac{-1}{x \cdot x}
\end{autobreak}
\end{align*}
...
\begin{align*}
\begin{autobreak}
\frac{d}{dx}((0 - \cos(\sin(x)) \cdot \cos(x)) \cdot \cos(x) + (0 - \sin(\sin(x))) \cdot (0 - \sin(x)) + x^{3} \cdot 3 \cdot \frac{1}{x} \cdot 3 \cdot \frac{1}{x} + x^{3} \cdot 3 \cdot \frac{-1}{x \cdot x}) = \frac{d}{dx}((0 - \cos(\sin(x)) \cdot \cos(x)) \cdot \cos(x) + (0 - \sin(\sin(x))) \cdot (0 - \sin(x))) + \frac{d}{dx}(x^{3} \cdot 3 \cdot \frac{1}{x} \cdot 3 \cdot \frac{1}{x} + x^{3} \cdot 3 \cdot \frac{-1}{x \cdot x})
\end{autobreak}
\end{align*}
...
\begin{align*}
\begin{autobreak}
\frac{d}{dx}(x^{3} \cdot 3 \cdot \frac{1}{x} \cdot 3 \cdot \frac{1}{x} + x^{3} \cdot 3 \cdot \frac{-1}{x \cdot x}) = \frac{d}{dx}(x^{3} \cdot 3 \cdot \frac{1}{x} \cdot 3 \cdot \frac{1}{x}) + \frac{d}{dx}(x^{3} \cdot 3 \cdot \frac{-1}{x \cdot x})
\end{autobreak}
\end{align*}
...
\begin{align*}
\begin{autobreak}
\frac{d}{dx}(x^{3} \cdot 3 \cdot \frac{-1}{x \cdot x}) = \frac{d}{dx}(x^{3}) \cdot 3 \cdot \frac{-1}{x \cdot x} + x^{3} \cdot \frac{d}{dx}(3 \cdot \frac{-1}{x \cdot x})
\end{autobreak}
\end{align*}
...
\begin{align*}
\begin{autobreak}
\frac{d}{dx}(3 \cdot \frac{-1}{x \cdot x}) = \frac{d}{dx}(3) \cdot \frac{-1}{x \cdot x} + 3 \cdot \frac{d}{dx}(\frac{-1}{x \cdot x})
\end{autobreak}
\end{align*}
...
\begin{align*}
\begin{autobreak}
\frac{d}{dx}(x^{3} \cdot 3 \cdot \frac{1}{x} \cdot 3 \cdot \frac{1}{x}) = \frac{d}{dx}(x^{3} \cdot 3 \cdot \frac{1}{x}) \cdot 3 \cdot \frac{1}{x} + x^{3} \cdot 3 \cdot \frac{1}{x} \cdot \frac{d}{dx}(3 \cdot \frac{1}{x})
\end{autobreak}
\end{align*}
...
\begin{align*}
\begin{autobreak}
\frac{d}{dx}((0 - \cos(\sin(x)) \cdot \cos(x)) \cdot \cos(x) + (0 - \sin(\sin(x))) \cdot (0 - \sin(x))) = \frac{d}{dx}((0 - \cos(\sin(x)) \cdot \cos(x)) \cdot \cos(x)) + \frac{d}{dx}((0 - \sin(\sin(x))) \cdot (0 - \sin(x)))
\end{autobreak}
\end{align*}
...
\subsection{Полный план сражения с Тейлором-Боблином}
f(x) = \begin{align*}
\begin{autobreak}
1.66637 + \frac{2.59714}{1} \cdot x - 1^{1} + \frac{6.43289}{2} \cdot x - 1^{2} + \frac{7.42936}{6} \cdot x - 1^{3}
\end{autobreak}
\end{align*}
