...
\begin{align*}
\begin{autobreak}
\frac{d}{dx}((\cos(x) \cdot \cos(x) \cdot \cos(x) \cdot \cos(x))^{(\cos(x) \cdot \cos(x))}) = (\cos(x) \cdot \cos(x) \cdot \cos(x) \cdot \cos(x))^{(\cos(x) \cdot \cos(x))} \cdot ( \frac{d}{dx}(\cos(x) \cdot \cos(x)) \cdot \ln(\cos(x) \cdot \cos(x) \cdot \cos(x) \cdot \cos(x)) + \cos(x) \cdot \cos(x) \cdot \frac{d}{dx}(\cos(x) \cdot \cos(x) \cdot \cos(x) \cdot \cos(x)) / \cos(x) \cdot \cos(x) \cdot \cos(x) \cdot \cos(x) )
\end{autobreak}
\end{align*}
