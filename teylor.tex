...
\begin{align*}
\begin{autobreak}
\frac{d}{dx}(x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) = \frac{d}{dx}(x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x})) + \frac{d}{dx}(x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}))
\end{autobreak}
\end{align*}
