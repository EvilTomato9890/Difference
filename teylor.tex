...
\begin{center}
\begin{math}
\frac{d}{dx}(B + C + A) = \frac{d}{dx}((x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) + \frac{d}{dx}(x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x}))
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Родственники Боблина продолжают лезть к вам, держите посох крепче!
...
\begin{center}
A = \begin{math}
x^{x} \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x})
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
\begin{math}
\frac{d}{dx}(A) = \frac{d}{dx}(x^{x}) \cdot \frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x} + x^{x} \cdot \frac{d}{dx}(\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x})
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Их не становиться меньше, откуда они только лезут?!
...
\begin{center}
\begin{math}
\frac{d}{dx}(A + B) = \frac{d}{dx}((x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\ln(x) + \frac{x}{x})) + \frac{d}{dx}(x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}))
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Их не становиться меньше, откуда они только лезут?!
...
\begin{center}
Текущий ход событий: \begin{math}
(E + L + A) \cdot (\ln(x) + \frac{x}{x}) + B + C + G + D + H + I + x^{x} \cdot (\frac{0 - -1 \cdot (x + x)}{x \cdot x \cdot x \cdot x} + \frac{J - F}{K})
\end{math}\par\vspace{2em}
\end{center}
\noindent\hrulefill\begin{center}
Небольшой взмах посохом — и план сражения выглядит куда приличнее.
...
\begin{center}
\begin{math}
\frac{d}{dx}((E + L + A) \cdot N + B + C + G + D + H + I + x^{x} \cdot (M + \frac{J - F}{K})) = \frac{d}{dx}(((x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x})) \cdot (\ln(x) + \frac{x}{x}) + (x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + (x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x})) + \frac{d}{dx}((x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x}) + x^{x} \cdot (\frac{0 - -1 \cdot (x + x)}{x \cdot x \cdot x \cdot x} + \frac{(0 - (x - x) \cdot 2) \cdot x \cdot x \cdot x \cdot x - (0 - (x - x) \cdot (x + x)) \cdot ((x + x) \cdot x \cdot x + x \cdot x \cdot (x + x))}{x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x}))
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Один из гоблинов упал
...
\begin{center}
\begin{math}
\frac{d}{dx}(A + C + D + x^{x} \cdot (\frac{0 - -1 \cdot (x + x)}{x \cdot x \cdot x \cdot x} + \frac{E - B}{F})) = \frac{d}{dx}((x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x})) + \frac{d}{dx}(x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x}) + x^{x} \cdot (\frac{0 - -1 \cdot (x + x)}{x \cdot x \cdot x \cdot x} + \frac{(0 - (x - x) \cdot 2) \cdot x \cdot x \cdot x \cdot x - (0 - (x - x) \cdot (x + x)) \cdot ((x + x) \cdot x \cdot x + x \cdot x \cdot (x + x))}{x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x}))
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Родственники Боблина продолжают лезть к вам, держите посох крепче!
...
\begin{center}
\begin{math}
\frac{d}{dx}(B + x^{x} \cdot (\frac{0 - -1 \cdot (x + x)}{x \cdot x \cdot x \cdot x} + \frac{C - A}{D})) = \frac{d}{dx}(x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x})) + \frac{d}{dx}(x^{x} \cdot (\frac{0 - -1 \cdot (x + x)}{x \cdot x \cdot x \cdot x} + \frac{(0 - (x - x) \cdot 2) \cdot x \cdot x \cdot x \cdot x - (0 - (x - x) \cdot (x + x)) \cdot ((x + x) \cdot x \cdot x + x \cdot x \cdot (x + x))}{x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x}))
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Битва продолжается, не теряйте духу, они когда-то, наверное, закончаться!
...
\begin{center}
\begin{math}
\frac{d}{dx}(x^{x} \cdot (\frac{0 - -1 \cdot (x + x)}{x \cdot x \cdot x \cdot x} + \frac{B - A}{C})) = \frac{d}{dx}(x^{x}) \cdot \frac{0 - -1 \cdot (x + x)}{x \cdot x \cdot x \cdot x} + \frac{(0 - (x - x) \cdot 2) \cdot x \cdot x \cdot x \cdot x - (0 - (x - x) \cdot (x + x)) \cdot ((x + x) \cdot x \cdot x + x \cdot x \cdot (x + x))}{x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x} + x^{x} \cdot \frac{d}{dx}(\frac{0 - -1 \cdot (x + x)}{x \cdot x \cdot x \cdot x} + \frac{(0 - (x - x) \cdot 2) \cdot x \cdot x \cdot x \cdot x - (0 - (x - x) \cdot (x + x)) \cdot ((x + x) \cdot x \cdot x + x \cdot x \cdot (x + x))}{x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x})
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Их не становиться меньше, откуда они только лезут?!
...
\begin{center}
\begin{math}
\frac{d}{dx}(\frac{0 - -1 \cdot (x + x)}{x \cdot x \cdot x \cdot x} + \frac{B - A}{x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x}) = \frac{d}{dx}(\frac{0 - -1 \cdot (x + x)}{x \cdot x \cdot x \cdot x}) + \frac{d}{dx}(\frac{(0 - (x - x) \cdot 2) \cdot x \cdot x \cdot x \cdot x - (0 - (x - x) \cdot (x + x)) \cdot ((x + x) \cdot x \cdot x + x \cdot x \cdot (x + x))}{x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x})
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Вот так и рождаются легенды о герое, истребившем половину рода Боблина.
...
\begin{center}
\begin{math}
\frac{d}{dx}(\frac{B - A}{x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x}) = \frac{\frac{d}{dx}((0 - (x - x) \cdot 2) \cdot x \cdot x \cdot x \cdot x - (0 - (x - x) \cdot (x + x)) \cdot ((x + x) \cdot x \cdot x + x \cdot x \cdot (x + x))) \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x - (0 - (x - x) \cdot 2) \cdot x \cdot x \cdot x \cdot x - (0 - (x - x) \cdot (x + x)) \cdot ((x + x) \cdot x \cdot x + x \cdot x \cdot (x + x)) \cdot \frac{d}{dx}(x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x)}{{x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x \cdot x}^2}
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Небольшой взмах посохом — и план сражения выглядит куда приличнее.
...
\begin{center}
\begin{math}
\frac{d}{dx}(A) = \frac{d}{dx}(x \cdot x \cdot x \cdot x) \cdot x \cdot x \cdot x \cdot x + x \cdot x \cdot x \cdot x \cdot \frac{d}{dx}(x \cdot x \cdot x \cdot x)
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Один из гоблинов упал
...
\begin{center}
\begin{math}
\frac{d}{dx}(B - A) = \frac{d}{dx}((0 - (x - x) \cdot 2) \cdot x \cdot x \cdot x \cdot x) - \frac{d}{dx}((0 - (x - x) \cdot (x + x)) \cdot ((x + x) \cdot x \cdot x + x \cdot x \cdot (x + x)))
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Родственники Боблина продолжают лезть к вам, держите посох крепче!
...
\begin{center}
\begin{math}
\frac{d}{dx}(A) = \frac{d}{dx}((x + x) \cdot x \cdot x) + \frac{d}{dx}(x \cdot x \cdot (x + x))
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Их не становиться меньше, откуда они только лезут?!
...
\begin{center}
\begin{math}
\frac{d}{dx}(A + B) = \frac{d}{dx}((x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) + \frac{d}{dx}(x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x}))
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Вот так и рождаются легенды о герое, истребившем половину рода Боблина.
...
\begin{center}
\begin{math}
\frac{d}{dx}((D + F + A) \cdot G + B + C + E) = \frac{d}{dx}(((x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x})) \cdot (\ln(x) + \frac{x}{x}) + (x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) + \frac{d}{dx}((x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x}))
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Их не становиться меньше, откуда они только лезут?!
...
\begin{center}
\begin{math}
\frac{d}{dx}((C + D + A) \cdot (\ln(x) + \frac{x}{x}) + B) = \frac{d}{dx}(((x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x})) \cdot (\ln(x) + \frac{x}{x})) + \frac{d}{dx}((x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}))
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Их не становиться меньше, откуда они только лезут?!
...
\begin{center}
\begin{math}
\frac{d}{dx}((B + C + A) \cdot (\ln(x) + \frac{x}{x})) = \frac{d}{dx}((x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x})) \cdot \ln(x) + \frac{x}{x} + (x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x})) \cdot (\ln(x) + \frac{x}{x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\ln(x) + \frac{x}{x}) \cdot (\frac{1}{x} + \frac{x - x}{x \cdot x}) + x^{x} \cdot (\frac{-1}{x \cdot x} + \frac{0 - (x - x) \cdot (x + x)}{x \cdot x \cdot x \cdot x}) \cdot \frac{d}{dx}(\ln(x) + \frac{x}{x})
\end{math}\par\vspace{2em}
\end{center}
\begin{center}
Их не становиться меньше, откуда они только лезут?!
...
\begin{center}
\begin{math}
1 + \frac{8154.49}{1} \cdot (x - 1)^{1} + \frac{21903.6}{2} \cdot (x - 1)^{2} + \frac{60293}{6} \cdot (x - 1)^{3} + \frac{169544}{24} \cdot (x - 1)^{4} + \frac{485885}{120} \cdot (x - 1)^{5}
\end{math}\par\vspace{2em}
\end{center}
\end{document}
